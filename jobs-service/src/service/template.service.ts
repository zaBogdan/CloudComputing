...
class TemplateService {
    ...
    async createTemplate(name: string, tags: string[], parameters: any, substitute: any[], owner: string) {
    ...
    async updateTemplate(templateId: string, owner: string, name: string, tags: string[], parameters: any, substitute: any[]) {
        ...
        if (name && name !== template.name) {
            const templatesWithSameName = await this.findBy({ name: (name as string), owner });
